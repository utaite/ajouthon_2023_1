...
const TextStyle textBlack10 = TextStyle(fontSize: 10, color: Colors.black);
const TextStyle textBlack14 = TextStyle(fontSize: 14, color: Colors.black);
const TextStyle textBlack16 = TextStyle(fontSize: 16, color: Colors.black);
